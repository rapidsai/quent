...
/// analyzer to `analyzer.{remote,commit}`; empty `[workspace]` keeps the
/// generated crate out of parent workspaces.
...
/// port come from env so one built binary serves any artifacts.
