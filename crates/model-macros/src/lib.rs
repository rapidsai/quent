...
/// detect `#[resource_group]`).
///
/// **Do not use `#[derive(ResourceGroup)]` directly.** Resource groups are
/// entities — use `#[derive(Entity)]` with `#[resource_group]` instead.
/// This derive exists only for backward compatibility.
///
