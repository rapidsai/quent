...
int main() {
    ...
    engine_obs->init(engine_id, quent::engine::Init{
        .implementation = quent::engine::Implementation{
            .name = "TestEngine",
            .version = "1.0.0",
    ...
    plan_obs->declaration(plan_id, quent::plan::Declaration{
        .parent = quent::plan::Parent{
    ...
    // Operator: declaration with plan reference, parent operators, and custom attrs.
